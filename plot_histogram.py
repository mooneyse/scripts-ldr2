...
'''Plot the LDR2 PyBDSF data as histograms to make cuts for artefacts.'''
...
def main(csv='/mnt/closet/ldr2-blazars/catalogues/ldr2-bzcat-vaneck-ned-noise.csv'):
